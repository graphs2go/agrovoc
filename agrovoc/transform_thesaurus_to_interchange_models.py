...
from agrovoc.models import Concept, Label, Thesaurus
...
#
#     with ReleaseGraph.open(thesaurus_descriptor, read_only=True) as thesaurus:
#         while True:
...
#     with ReleaseGraph.open(input_, read_only=True) as thesaurus:
